...
import com.tinz.ntyw.service.WaterReportDayService;
import com.tinz.ntyw.token.TokenUtil;
 
@Controller
@RequestMapping(value = "/api/water/day")
public class WaterReportDayController {

	private Response response = new Response();
	@Autowired
	WaterReportDayService mService;
	@Autowired
