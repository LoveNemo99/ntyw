...
import com.tinz.ntyw.service.GasReportMonthService;
import com.tinz.ntyw.token.TokenUtil;
 
@Controller
@RequestMapping(value = "/api/gas/month")
public class GasReportMonthController {

	private Response response = new Response();
	@Autowired
	GasReportMonthService mService;
	@Autowired
