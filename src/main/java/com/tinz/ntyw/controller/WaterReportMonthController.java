...
import com.tinz.ntyw.service.WaterReportMonthService;
import com.tinz.ntyw.token.TokenUtil;
 
@Controller
@RequestMapping(value = "/api/water/month")
public class WaterReportMonthController {

	private Response response = new Response();
	@Autowired
	WaterReportMonthService mService;
	@Autowired
