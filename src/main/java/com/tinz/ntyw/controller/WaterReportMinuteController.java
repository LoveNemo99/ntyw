...
import com.tinz.ntyw.service.WaterReportMinuteService;
import com.tinz.ntyw.token.TokenUtil;
 
@Controller
@RequestMapping(value = "/api/water/minute")
public class WaterReportMinuteController {

	private Response response = new Response();
	@Autowired
	WaterReportMinuteService mService;
	@Autowired
