...
import com.tinz.ntyw.service.WaterReportYearService;
import com.tinz.ntyw.token.TokenUtil;
 
@Controller
@RequestMapping(value = "/api/water/year")
public class WaterReportYearController {

	private Response response = new Response();
	@Autowired
	WaterReportYearService mService;
	@Autowired
