...
import com.tinz.ntyw.service.WaterReportHourService;
import com.tinz.ntyw.token.TokenUtil;
 
@Controller
@RequestMapping(value = "/api/water/hour")
public class WaterReportHourController {

	private Response response = new Response();
	@Autowired
	WaterReportHourService mService;
	@Autowired
