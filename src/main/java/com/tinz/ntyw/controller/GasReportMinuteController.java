...
import com.tinz.ntyw.service.GasReportMinuteService;
import com.tinz.ntyw.token.TokenUtil;
 
@Controller
@RequestMapping(value = "/api/gas/minute")
public class GasReportMinuteController {

	private Response response = new Response();
	@Autowired
	GasReportMinuteService mService;
	@Autowired
